...
create table orders (id int8 generated by default as identity, order_status varchar(255) default 'ACTIVE', "date" date,
end_time time, start_time time, box_id int8 not null, user_id int8 not null, cost numeric(19, 2) not null,primary key (id));
